...
llm=ChatGoogleGenerativeAI(google_api_key=key, model="gemini-2.0-flash-exp", temperature=0.7)
...
generate_evaluate_chain=SequentialChain(chains=[quiz_chain,review_chain],
                                        input_variables=["text","number","tone","subject","response_json"],output_variables=["quiz","review"],verbose=True)